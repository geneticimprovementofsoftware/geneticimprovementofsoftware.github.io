...
Navigation: [Event](#attending), [Important Dates](#important-dates), [Keynote](#keynote), [Accepted Papers](#accepted-papers), [Schedule](#schedule), [CFP](#CFP), [Workshops Chairs](#chairs), [Program Committee](#PC)

## Event

The 15th instalment of the GI workshop took place in Rio de Janeiro, Brazil, co-located with the 48th International Conference on Software Engineering, [ICSE 2026](https://conf.researchr.org/home/icse-2026), which will be held at the [Windsor Barra Hotel](https://windsorhoteis.com/hotel/windsor-oceanico/?l=EN).

- **<span style="color:#C9B037"><i class="fa-solid fa-award"></i> best paper award</span>: GI-Agent Search-Based LLM Agent for Code Optimization with Genetic Improvement** &mdash; Donghyun Lee, William B. Langdon, and Justyna Petke
- **<span style="color:#C9B037"><i class="fa-solid fa-award"></i> best presentation award</span>: Applying Genetic Improvement Techniques for Automated Program Repair of Transpiled Code** &mdash; Prasham Jadhwani, Carol Hanna, William B. Langdon, and Justyna Petke
...
{% assign entries = site.data.survey.papers | where: "venue", "GI@ICSE" | where: "year", 2026 %}
...
This schedule appears in Rio de Janeiro's time zone (GMT-3, Brasília Time); compare to your timezone [here](https://time.is/compare/Rio_de_Janeiro).  
...
The workshop will take place at the [Windsor Barra Hotel](https://windsorhoteis.com/hotel/windsor-oceanico/?l=EN) in Room Bora Bora IV. 
See also the [schedule on the ICSE website](https://conf.researchr.org/program/icse-2026/program-icse-2026/?track=GI) for easy bookmarking.
-   Monday 13 April 2026 09:00-10:30 (90 minutes; chair: Vesna Nowack)
    -   [09:00](https://time.is/0900_13_April_2026_in_Rio_de_Janeiro):
        **Welcome** and **Introductions - Aymeric Blot** (10 minutes)
    -   [09:10](https://time.is/0910_13_April_2026_in_Rio_de_Janeiro):
        **Keynote speech** — *Genetic Improvement for Software
        Modernization: Synergy and Opportunities* — **Wesley Klewerton
        Guez Assunção** (60 minutes)
    -   [10:10](https://time.is/1010_13_April_2026_in_Rio_de_Janeiro):
        *Improving a Parallel C++ Intel SSE SIMD Linear Genetic
        Programming Interpreter* — **William B. Langdon** and **Carol
        Hanna** (15+5 minutes)
    -   [10:30](https://time.is/1030_13_April_2026_in_Rio_de_Janeiro):
        Break & Morning tea (30 minutes)
-   Monday 13 April 2026 11:00-12:30 (90 minutes; chair: Aymeric Blot)
    -   [11:00](https://time.is/1100_13_April_2026_in_Rio_de_Janeiro):
        **Mini-Tutorial** (30 minutes)
    -   [11:30](https://time.is/1130_13_April_2026_in_Rio_de_Janeiro):
        *Applying Genetic Improvement Techniques for Automated Program
        Repair of Transpiled Code* — **Prasham Jadhwani**, **Carol
        Hanna**, **William B. Langdon**, and **Justyna Petke**
        (15+5 minutes)
    -   [11:50](https://time.is/1150_13_April_2026_in_Rio_de_Janeiro):
        *GI-Agent: Search-Based LLM Agent for Code Optimization with
        Genetic Improvement* — **Donghyun Lee**, **William B. Langdon**,
        and **Justyna Petke** (15+5 minutes)
    -   [12:10](https://time.is/1210_13_April_2026_in_Rio_de_Janeiro):
        *Databending as a Target for Genetic Improvement* — **Erik
        Fredericks**, **Byron DeVries**, and **Reihaneh Hariri**
        (12+3 minutes)
    -   [12:25](https://time.is/1225_13_April_2026_in_Rio_de_Janeiro):
        **Closing** (5 minutes)
    -   [12:30](https://time.is/1230_13_April_2026_in_Rio_de_Janeiro):
        Lunch (90 minutes)
