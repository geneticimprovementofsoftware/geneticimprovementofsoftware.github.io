...
Navigation: [Event](#attending), [Important Dates](#important-dates), [Keynote](#keynote), [CFP](#CFP), [Workshops Chairs](#chairs), [Program Committee](#PC)

## Event

The 14th instalment of the GI workshop took place in Ottawa, collocated with the 47th International Conference on Software Engineering, [ICSE 2025](https://conf.researchr.org/home/icse-2025), which will be held in [Ottawa’s Shaw Centre](https://conf.researchr.org/venue/icse-2025/icse-2025-venue).

- **<span style="color:#C9B037"><i class="fa-solid fa-award"></i> best paper award</span>: Large Language Model based Code Completion is an Effective Genetic Improvement Mutation** &mdash; Jingyuan Wang, Carol Hanna, and Justyna Petke
- **<span style="color:#C9B037"><i class="fa-solid fa-award"></i> best presentation award</span>: LLM-Assisted Crossover in Genetic Improvement of Software** &mdash; Dimitrios Stamatios Bouras, Justyna Petke, and Sergey Mechtaev
