...
<figure class="figure" style="text-align: center; margin: 0.5em 1em; width: 165px;">
  <img class="figure-img rounded img-thumbnail" style="max-width: 180px; max-height: 160px;" src="{{ match.img | relative_url }}" onerror="this.onerror=null; this.src='{{ "/profile_images/blank.jpg" | relative_url }}'" />
...
![UKRI](https://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/UK_Research_and_Innovation_logo.svg/753px-UK_Research_and_Innovation_logo.svg.png)