...
Registration details will be available later on the ICSE website.
...
<figure class="figure float-left" style="width:160px; margin: auto 1em;">
  <div class="float-right">
    <img class="figure-img rounded img-thumbnail" style="max-width: 160px; max-height: 160px;" src="{{ match.img | relative_url }}" onerror="this.onerror=null; this.src='{{ "/profile_images/blank.jpg" | relative_url }}'">
