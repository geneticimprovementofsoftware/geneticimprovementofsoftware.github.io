...
<img align="right"  alt="drawing" width="120px" src="{{ "/profile_images/mark.jpg" | relative_url }}">

[Mark Harman](http://www0.cs.ucl.ac.uk/staff/M.Harman/) (Facebook, University College London) gave the keynote speech in GI 2020 ([link to paper](https://research.fb.com/wp-content/uploads/2020/04/WES-Agent-based-User-Interaction-Simulation-on-Real-Infrastructure.pdf)).
...
<img align="right"  alt="drawing" width="120px" src="{{ "/profile_images/shin_yoo.jpg" | relative_url }}">
...
<img align="right"  alt="drawing" width="120px" src="{{ "/profile_images/bobby_bruce.jpg" | relative_url }}">
...
<figure class="figure" style="text-align: center; margin: 0.5em 1em; width: 120px;">
  <img class="figure-img" style="max-width: 120px; max-height: 120px;" src="{{ p.img | relative_url }}" onerror="this.onerror=null; this.src='{{ "/profile_images/empty.jpg" | relative_url }}'" />
